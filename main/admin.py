...
class DomainAdmin(ImportExportModelAdmin):
    ...
    fieldsets = (
        ...
        (
            _("Service"),
            {"fields": ("site_on", "site_on_backup", "mail_on", "mail_on_backup")},
        ),
    )
        ...
        (
            _("Online Panel"),
            {
                "fields": (
                    ...
                    "administration_panel_username",
                    "administration_panel_password",
                )
            },
        ),
        (
            _("Ssh"),
            {"fields": ("server_address", "ssh_username", "ssh_password", "notes")},
        ),
    )
...
class ProjectAdmin(admin.ModelAdmin):
    inlines = [FrontendTestInline, DeadlineInline]
    fieldsets = (
        (
            _("General"),
            {
